...
print ('\033[1;37m[\033[1;32m•\033[1;37m]WELCOME TOOL BY DEEP XD FB CREATE ACCOUNT')    
print ('\033[1;37m[\033[1;32m•\033[1;37m]FOLLOW ONWER ACCOUNT MORE UPDATE')    
...
def menu():
    ...
    if sel in['1', '01']:
        ...
        os.system('xdg-open https://facebook.com/groups/470830612191057/')
        menu()
    elif sel in ['3', '03']:
        exit()
    else:
...
class create:
    ...
    def start(self):
        os.system('clear')
        print (logo4)
        print ('[1] BOY NAME CREATE')
        print ('[2] GIRL NAME CREATE')
        print (47*'-')
        gen = input('select: ')
        print (47*'-')
        if gen in ['1', '01']:
        ...
        for x in range(lim):
            self.loop += 1
            sys.stdout.write(f'\r {OO}[AUTO-CREATE-FB] {OO}{self.loop}/{str(lim)} OK:{len(ok)} '),
            sys.stdout.flush()
            ...
            try:
                ...
                if 'checkpoint' in getts.url:
                    ...
                    print ('\r\033[1;31m[AUTO-CREATE-CP] '+cok['c_user']+' | '+passw+'\033[0;97m     ')
                        ...
                        for x in BeautifulSoup(po.text, 'html.parser').find_all('form', {'method': 'post'}):
                            if 'confirmation_event_location=cliff' in str(x):
                                ...
                                if 'checkpoint' in rex.url:
                                    ...
                                    cok = self.ses.cookies.get_dict()
                                    print ('\r\033[1;32m[AUTO-CREATE-OK] '+cok['c_user']+' | '+passw+'\033[0;97m     ')                                                                      
                                    print ('\r\033[1;37m[COOKIES] '+coki+'\033[0;97m     ')                                    
                                    open('/sdcard/Auto-create-ok.txt', 'a').write( cok['c_user']+' | '+passw+' | '+coki+'\n')
